package com.hunqingplatform.hunqing.common.page;
...
public class DaoSearch {
    ...
    @ApiModelProperty(name = "order", value = "排序字段", example = "cmtDate")
    private String order;
    
    @ApiModelProperty(name = "sortOrder", value = "排序规则", example = "desc:降序，asc:升序")
